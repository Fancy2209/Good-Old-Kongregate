**Before installing this script, make sure that you have installed (and enabled) a user script manager (a browser extension such as Tampermonkey, Violentmonkey, Greasemonkey  or another monkey).**
