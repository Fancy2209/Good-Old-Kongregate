...
(function() {
  ...
  // Find the Things
  const kNavbar = document.querySelector('k-navbar[theme="kong"][data-controller="session components--ui--navigation--navbar"]');
...
`;
  if (kNavbar) {
      ...
      kNavbar.parentElement.insertBefore(newDiv, kNavbar);
      kNavbar.remove();
  }
